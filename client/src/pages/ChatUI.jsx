...
const ChatUI = () => {
  ...
  const socialLinks = [
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/apoorv-nath-tripathi-787848231",
      icon: Linkedin,
    },
    { name: "GitHub", url: "https://github.com/noobapoo99", icon: Github },
    { name: "LeetCode", url: " https://leetcode.com/u/noobappo_99", icon: Code },
    {
      name: "Portfolio",
      url: " https://apoorv-tripathi.netlify.app",
      icon: Briefcase,
    },
    // {
    //   name: "Docker Hub",
  ...
  const sendMessageWithSteps = async (messageText) => {
    ...
    try {
      ...
      const classifyRes = await axios.post(
        "https://apoorv-bot-backend.onrender.com/api/classify",
      ...
      const answerRes = await axios.post(
        "https://apoorv-bot-backend.onrender.com/api/chat",
