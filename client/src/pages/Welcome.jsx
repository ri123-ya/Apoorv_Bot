...
const Welcome = () => {
  ...
  const exampleQuestions = [
    "What projects has Apoorv worked on?",
    ...
    >
      ...
      >
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-gray-100 text-center mb-6 tracking-wide">
          Welcome to ApoorvBOT
        </h1>

        <p className="text-gray-300 text-center mb-8 text-base md:text-lg max-w-2xl mx-auto">
          Hi, I’m <span className="text-blue-400 font-semibold">Apoorv</span> —
          Thank you for visiting. ApoorvBOT is here to share details of my skills
